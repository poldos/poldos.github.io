...
<link onload="this.media='all';this.onload=null;" rel="stylesheet" href="css/site.013fe5.css" media="print">
</head>
<body id="b">
...
<a href="blog-index.php" class="ml2"><div class="menu-content mcv2"><div class="v7 ps19 s23 c38"><div class="v7 ps19 s23 c37"><p class="p4 f8">Blog</p></div></div></div></a>
</li>
</ul>
</div>
</div>
...
<?php
    ...
    $control = '<div class="v4 ps14 s16 c20 {btnclass}"><a href="blog-index.php" class="f7 btn1 v6 s17 {lnkclass}">&lt;&lt;</a></div>';
    if($page > 1) {
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c21 {btnclass}"><a href="blog-index.php" class="f7 btn2 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c22 {btnclass}"><a href="blog-index.php" class="f7 btn3 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c23 {btnclass}"><a href="blog-index.php" class="f7 btn4 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c24 {btnclass}"><a href="blog-index.php" class="f7 btn5 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c25 {btnclass}"><a href="blog-index.php" class="f7 btn6 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c26 {btnclass}"><a href="blog-index.php" class="f7 btn7 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c27 {btnclass}"><a href="blog-index.php" class="f7 btn8 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c28 {btnclass}"><a href="blog-index.php" class="f7 btn9 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c29 {btnclass}"><a href="blog-index.php" class="f7 btn10 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c30 {btnclass}"><a href="blog-index.php" class="f7 btn11 v6 s17 {lnkclass}">{page_num}</a></div>';
...
<?php
    ...
    $control = '<div class="v4 ps15 s16 c31 {btnclass}"><a href="blog-index.php" class="f7 btn12 v6 s17 {lnkclass}">&gt;&gt;</a></div>';
    if($page < $end_page) {
        $url = strtok($_SERVER['REQUEST_URI'],'?') . '?page=' . ($page + 1);
        if($tag !== NULL) {
            $url .= '&tag=' . $tag;
